...
/////////////////
const BotName = '⚡LBOT⚡'; 
const instagram = 'https://instagram.com/lky_design20'; 
const telegram = 'GA PUNYA!'; 
const kapanbotaktif = 'KETIKA HANYA DIAKTIFKAN'; 
const youtube = 'https://www.youtube.com/c/ZORINA';
...
const get = require('got')
   ...
   if (text.includes("+katacinta"))
   {
      var url = 'https://jagokata.com/kata-bijak/kata-cinta.html'
      axios.get(url)
         .then((result) =>
         {
...
await new Promise(resolve => setTimeout(resolve, 500));
  ...
  conn.sendMessage("Textnya kepanjangan!")
}else{
